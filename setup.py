...
setup(
    name="cassiopeia",
    version="4.0.14",  # Keep the Cass version at parity with the Riot API major version, use the minor version for breaking changes, and the patch version for everything else
