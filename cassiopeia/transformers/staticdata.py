...
class StaticDataTransformer(DataTransformer):
    ...
    def champion_dto_to_data(
        self, value: ChampionDto, context: PipelineContext = None
    ) -> ChampionData:
        return ChampionData(**value)

    @transform.register(ChampionListDto, ChampionListData)
    def champion_list_dto_to_data(
        self, value: ChampionListDto, context: PipelineContext = None
    ) -> ChampionListData:
        data = deepcopy(value)
        ...
        return ChampionListData(
            ...
            locale=value["locale"],
            includedData=value["includedData"],
        )

    @transform.register(ChampionReleaseDto, ChampionReleaseData)
    def champion_releases_to_release(
        selfself, value: ChampionReleaseDto, context: PipelineContext = None
    ) -> ChampionReleaseData:
        return ChampionReleaseData(**value)

    @transform.register(ChampionRatesDto, ChampionRatesData)
    def champion_rates_dto_to_data(
        self, value: ChampionRatesDto, context: PipelineContext = None
    ) -> ChampionRatesData:
    ...
    def rune_dto_to_data(
        self, value: RuneDto, context: PipelineContext = None
    ) -> RuneData:
        return RuneData(**value)

    @transform.register(RuneListDto, RuneListData)
    def rune_list_dto_to_data(
        self, value: RuneListDto, context: PipelineContext = None
    ) -> RuneListData:
        data = deepcopy(value)
    ...
    def item_dto_to_data(
        self, value: ItemDto, context: PipelineContext = None
    ) -> ItemData:
        return ItemData(**value)

    @transform.register(ItemListDto, ItemListData)
    def item_list_dto_to_data(
        self, value: ItemListDto, context: PipelineContext = None
    ) -> ItemListData:
        data = deepcopy(value)
    ...
    def summoner_spell_dto_to_data(
        self, value: SummonerSpellDto, context: PipelineContext = None
    ) -> SummonerSpellData:
        return SummonerSpellData(**value)

    @transform.register(SummonerSpellListDto, SummonerSpellListData)
    def summoner_spell_list_dto_to_data(
        self, value: SummonerSpellListDto, context: PipelineContext = None
    ) -> SummonerSpellListData:
        data = deepcopy(value)

        data["data"] = [
            self.summoner_spell_dto_to_data(c) for c in data["data"].values()
        ]
        for c in data["data"]:
            c(
                region=data["region"],
    ...
    def map_dto_to_data(
        self, value: MapDto, context: PipelineContext = None
    ) -> MapData:
        return MapData(**value)

    @transform.register(MapListDto, MapListData)
    def map_list_dto_to_data(
        self, value: MapListDto, context: PipelineContext = None
    ) -> MapListData:
        data = deepcopy(value)
    ...
    def version_list_dto_to_data(
        self, value: VersionListDto, context: PipelineContext = None
    ) -> VersionListData:
    ...
    def realm_dto_to_data(
        self, value: RealmDto, context: PipelineContext = None
    ) -> RealmData:
    ...
    def languages_dto_to_data(
        self, value: LanguagesDto, context: PipelineContext = None
    ) -> LanguagesData:
        data = deepcopy(value)
    ...
    def champion_data_to_core(
        self, value: ChampionData, context: PipelineContext = None
    ) -> Champion:
        return Champion.from_data(value, loaded_groups={ChampionData})

    # @transform.register(ChampionListData, Champions)
    def champion_list_data_to_core(
        self, value: ChampionListData, context: PipelineContext = None
    ) -> Champions:
        return Champions.from_data(
            *[self.champion_data_to_core(c) for c in value],
            region=value.region,
            version=value.version,
            locale=value.locale,
            included_data=value.includedData
        )

    # Rune

    # @transform.register(RuneData, Rune)
    def rune_data_to_core(
        self, value: RuneData, context: PipelineContext = None
    ) -> Rune:
        return Rune.from_data(value)

    # @transform.register(RuneListData, Runes)
    def rune_list_data_to_core(
        self, value: RuneListData, context: PipelineContext = None
    ) -> Runes:
        return Runes.from_data(
            *[self.rune_data_to_core(r) for r in value],
            region=value.region,
            version=value.version,
            locale=value.locale,
            included_data=value.includedData
    ...
    def item_data_to_core(
        self, value: ItemData, context: PipelineContext = None
    ) -> Item:
        return Item.from_data(value)

    # @transform.register(ItemListData, Items)
    def item_list_data_to_core(
        self, value: ItemListData, context: PipelineContext = None
    ) -> Items:
        return Items.from_data(
            *(self.item_data_to_core(i) for i in value),
            region=value.region,
            version=value.version,
            locale=value.locale,
            included_data=value.includedData
    ...
    def summoner_spell_data_to_core(
        self, value: SummonerSpellData, context: PipelineContext = None
    ) -> SummonerSpell:
        return SummonerSpell.from_data(value)

    # @transform.register(SummonerSpellListData, SummonerSpells)
    def summoner_spell_list_data_to_core(
        self, value: SummonerSpellListData, context: PipelineContext = None
    ) -> SummonerSpells:
        return SummonerSpells.from_data(
            *[self.summoner_spell_data_to_core(s) for s in value],
            region=value.region,
            version=value.version,
            locale=value.locale,
            included_data=value.includedData
    ...
    def map_list_data_to_core(
        self, value: MapListData, context: PipelineContext = None
    ) -> Maps:
        return Maps.from_data(
            *[self.map_data_to_core(m) for m in value],
            region=value.region,
            version=value.version,
            locale=value.locale
        )
    ...
    def version_list_data_to_core(
        self, value: VersionListData, context: PipelineContext = None
    ) -> Versions:
    ...
    def realm_data_to_core(
        self, value: RealmData, context: PipelineContext = None
    ) -> Realms:
    ...
    def languages_data_to_core(
        self, value: LanguagesData, context: PipelineContext = None
    ) -> Locales:
    ...
    def profile_icon_data_to_core(
        self, value: ProfileIconData, context: PipelineContext = None
    ) -> ProfileIcon:
