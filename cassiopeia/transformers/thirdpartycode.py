...
class ThirdPartyCodeTransformer(DataTransformer):
    ...
    def verification_string_dto_to_data(
        self, value: VerificationStringDto, context: PipelineContext = None
    ) -> VerificationStringData:
        return VerificationStringData(**value)

    # Data to Core

    # @transform.register(VerificationStringData, VerificationString)
    def verification_string_data_to_core(
        self, value: VerificationStringData, context: PipelineContext = None
    ) -> VerificationString:
