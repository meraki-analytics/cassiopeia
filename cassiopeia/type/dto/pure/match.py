import cassiopeia.type.dto.pure.common
import cassiopeia.type.core.common

@cassiopeia.type.core.common.inheritdocs
class MatchDetail(cassiopeia.type.dto.pure.common.CassiopeiaDto):
    """
...
@cassiopeia.type.core.common.inheritdocs
class Participant(cassiopeia.type.dto.pure.common.CassiopeiaDto):
    """
...
@cassiopeia.type.core.common.inheritdocs
class ParticipantIdentity(cassiopeia.type.dto.pure.common.CassiopeiaDto):
    """
    participantId    int       participant ID
...
@cassiopeia.type.core.common.inheritdocs
class Team(cassiopeia.type.dto.pure.common.CassiopeiaDto):
    """
...
@cassiopeia.type.core.common.inheritdocs
class Timeline(cassiopeia.type.dto.pure.common.CassiopeiaDto):
    """
...
@cassiopeia.type.core.common.inheritdocs
class Mastery(cassiopeia.type.dto.pure.common.CassiopeiaDto):
    """
...
@cassiopeia.type.core.common.inheritdocs
class ParticipantStats(cassiopeia.type.dto.pure.common.CassiopeiaDto):
    """
...
@cassiopeia.type.core.common.inheritdocs
class ParticipantTimeline(cassiopeia.type.dto.pure.common.CassiopeiaDto):
    """
...
@cassiopeia.type.core.common.inheritdocs
class Rune(cassiopeia.type.dto.pure.common.CassiopeiaDto):
    """
    rank      int    rune rank
    runeId    int    rune ID
    """
...
@cassiopeia.type.core.common.inheritdocs
class Player(cassiopeia.type.dto.pure.common.CassiopeiaDto):
    """
...
@cassiopeia.type.core.common.inheritdocs
class BannedChampion(cassiopeia.type.dto.pure.common.CassiopeiaDto):
    """
...
@cassiopeia.type.core.common.inheritdocs
class Frame(cassiopeia.type.dto.pure.common.CassiopeiaDto):
    """
...
@cassiopeia.type.core.common.inheritdocs
class ParticipantTimelineData(cassiopeia.type.dto.pure.common.CassiopeiaDto):
    """
    events               list<Event>                    list of events for this frame
    participantFrames    dict<str, ParticipantFrame>    map of each participant ID to the participant's information for the frame
    timestamp            int                            represents how many milliseconds into the game the frame occurred
...
@cassiopeia.type.core.common.inheritdocs
class Event(cassiopeia.type.dto.pure.common.CassiopeiaDto):
    """
...
@cassiopeia.type.core.common.inheritdocs
class ParticipantFrame(cassiopeia.type.dto.pure.common.CassiopeiaDto):
    """
...
@cassiopeia.type.core.common.inheritdocs
class Position(cassiopeia.type.dto.pure.common.CassiopeiaDto):
    """
    x    int    x position
    y    int    y position
    """
